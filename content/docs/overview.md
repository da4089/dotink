...
Ink supports string values. An Ink string is simply a byte slice, in the style of [Lua](https://www.lua.org/pil/2.4.html), and doesn't know about Unicode. We can construct a string literal by surrounding data with single quotes, and we can escape single quotes within a string literal with a backslash.
